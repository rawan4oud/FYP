...
# def compute_similarity_matrix(midi_file_path1, midi_file_path2, n):
#     # Step 1: Convert MIDI files to string sequences
#     string_sequences1 = main(midi_file_path1)
#     string_sequences2 = main(midi_file_path2)
...
#     matrix = compute_similarity_matrix(string_sequences1, string_sequences2, n)
